...
async function getCurrentUserDetails(authorizationHeaderProvider: () => Promise<string>, connectionProvider: () => Promise<WebApi>, userAgentProvider: () => string) {
 ...
 */
async function getUserIdFromEmail(userEmail: string, authorizationHeaderProvider: () => Promise<string>, connectionProvider: () => Promise<WebApi>, userAgentProvider: () => string): Promise<string> {
  const identities = await searchIdentities(userEmail, authorizationHeaderProvider, connectionProvider, userAgentProvider);
